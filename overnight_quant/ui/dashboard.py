...
FIELD_LABELS = {
    "zh": {
        "execution_ok": "程序执行成功",
        "data_ready": "数据就绪",
        "feature_event_cutoff": "特征事件截止",
        "collection_deadline": "采集完成截止",
        "execution_not_before": "模拟成交最早时间",
        "fund_flow_gate_notice": "资金流门禁说明",
        "status": "状态",
        "trade_date": "交易日期",
        "run_time": "运行时间",
        "session_state": "时段",
    ...
    "en": {
        ...
        "feature_event_cutoff": "Feature Event Cutoff",
        "collection_deadline": "Collection Deadline",
        "execution_not_before": "Execution Not Before",
        "fund_flow_gate_notice": "Fund Flow Gate Notice",
        "status": "Status",
